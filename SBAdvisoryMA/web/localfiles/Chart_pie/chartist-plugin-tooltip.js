    ...
    return function tooltip(chart) {
      ...
      on('mouseover', tooltipSelector, function (event) {
        ...
        if (options.tooltipFnc && typeof options.tooltipFnc === 'function') {
          ...
          //             tooltipText += value;
          //           }
          var position = Array.from(document.getElementsByClassName("ct-chart-pie")[0].childNodes).indexOf($point.parentNode);
          var xAxisValue = document.getElementsByClassName("ct-chart-pie")[0].lastChild.childNodes[position].innerHTML;
          tooltipText += xAxisValue;
        }
