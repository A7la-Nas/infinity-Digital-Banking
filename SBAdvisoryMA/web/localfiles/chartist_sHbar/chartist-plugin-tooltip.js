  ...
  Chartist.plugins.tooltip = function (options) {
    ...
    return function tooltip(chart) {
      ...
      on('mouseover', tooltipSelector, function (event) {
		...
		var position = Array.from($point.parentNode.children).indexOf($point);
        var xAxisValue = document.getElementsByClassName("ct-labels")[0].children[position].children[0].innerText;
