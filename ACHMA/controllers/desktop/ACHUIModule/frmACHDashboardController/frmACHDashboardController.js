  ...
  return {
      ...
      if (uiModel) {
        switch (uiModel.key) {
          ...
          case "achViewDetails":
            ...
            break;
          default:
            kony.print('Unreachable context!');
            break;
        }
    ...
    campaignSuccess: function (data) {
      if (applicationManager.getConfigurationManager().isMicroAppPresent('CampaignMA')) {
        var CampaignManagementModule = kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule({ "moduleName": "CampaignUIModule", "appName": "CampaignMA" });
    ...
    // common function for loading the ACHMA Presentation Controller
    loadACHModule: function () {
      return kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule("ACHUIModule");
      // return kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule({"moduleName" : "ACHUIModule", "appName" : "ACHMA"});
    },
    ...
    /**
     * @description preShow event function for frmACHDashboard
     */
    onPreShow: function () {
      var scopeObj = this;
      ...
      this.view.TabPaneNew.TabSearchBarNew.MobileCustomDropdown.flxIphoneDropdown.onClick = this.setDropdownVisibility;
      this.view.TabPaneNew.MobileCustomDropdown.flxIphoneDropdown.onClick = this.setDropdownVisibilityMobile;
    ...
    segViewTypesRowClick: function (lblvalue) {
      ...
      this.view.TabPaneNew.TabSearchBarNew.MobileCustomDropdown.flxIphoneDropdown.flxImage.imgDropdown.src = "dropdown_expand.png";
      this.invokeFetchACHTransactions();
    },
    ...
    segViewTypesRowClickMobile: function (lblvalue) {
      ...
      this.view.TabPaneNew.MobileCustomDropdown.flxIphoneDropdown.flxImage.imgDropdown.src = "dropdown_expand.png";
      this.invokeFetchACHTransactions();
    },
    ...
    setDropdownVisibility: function () {
      ...
      if (!this.view.TabPaneNew.TabSearchBarNew.MobileCustomDropdown.flxDropdown.isVisible) {
        ...
        this.view.TabPaneNew.TabSearchBarNew.MobileCustomDropdown.flxIphoneDropdown.flxImage.imgDropdown.src = "dropdown_collapse.png";
      } else {
        this.view.TabPaneNew.TabSearchBarNew.MobileCustomDropdown.flxDropdown.isVisible = false;
    ...
    setDropdownVisibilityMobile: function () {
      ...
      if (!this.view.TabPaneNew.MobileCustomDropdown.flxDropdown.isVisible) {
        ...
        this.view.TabPaneNew.MobileCustomDropdown.flxIphoneDropdown.flxImage.imgDropdown.src = "dropdown_collapse.png";
      } else {
        this.view.TabPaneNew.MobileCustomDropdown.flxDropdown.isVisible = false;
    ...
    fetchACHAccountTypes: function () {
      if (this.ACHAccountTypes === null || this.ACHAccountTypes === []) {
        ...
        this.loadACHModule().presentationController.getACHAccountTypes(navObj);
      }
    },
    ...
    fetchTaxTypes: function () {
      if (this.TaxTypes === null || this.TaxTypes === []) {
        ...
        this.loadACHModule().presentationController.getTaxTypes(navObj);
      }
    },
    ...
    fetchACHTemplates: function (sortParam, sortOrder) {
      ...
      this.loadACHModule().presentationController.getACHTemplatesData(navObj);
    },
    ...
    fetchACHTransactions: function (sortParam, sortOrder) {
      ...
      this.loadACHModule().presentationController.getACHTransactionsData(navObj);
    },
    ...
    //     }
    //   };
    //   this.ApprovalRequestsModule = kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule({ "moduleName": "ApprovalsReqUIModule", "appName": "ApprovalRequestMA" });
    ...
    fetchACHFiles: function (sortParam, sortOrder) {
      ...
      this.loadACHModule().presentationController.getAllACHFiles(navObj);
    },
    ...
    createUIForCreateTemplateOrCreateTransaction: function (UIType, isNotBack, params) {
      ...
      if (isNotBack) {
        ...
        this.loadACHModule().presentationController.getTemplateTypes(navObj);
    ...
    fetchTemplateRecordsForPayment: function (inputparams, templateParams) {
      ...
      this.loadACHModule().presentationController.getACHTemplateRecords(navObj);
      ...
      scopeObj.callGetCustomerActionLimits(featureAction, BBConstants.ON_FETCH_CUSTOMER_ACTION_LIMITS_IN_EXECUTE_TEMPLATE_FLOW, BBConstants.ON_FETCH_CUSTOMER_ACTION_LIMITS_FAILURE_IN_EXECUTE_TEMPLATE_FLOW);
    },
    ...
    saveAsTemplate: function () {
      ...
      this.loadACHModule().presentationController.saveTransaction(navObj);
    },
    ...
    populateACKTemplateRecords: function (requestType, rowDataMap, rows) {
      ...
      this.view.TemplateRecordsNew.lblCurrencySymbol.text = applicationManager.getConfigurationManager().getCurrencyCode();
      FormControllerUtility.hideProgressBar(this.view);
      this.adjustScreen(0);
    },
    ...
    populatePaymentTemplateRecords: function (requestType, rowDataMap, rows) {
      ...
      this.view.TemplateRecordsNew.TabBodyNew.addDataForSections(rows);
      var scope = this;
      var segDataTemp = this.view.TemplateRecordsNew.TabBodyNew.segTemplates.data;
      segDataTemp[0][1].forEach(function(paymentRow){
          if(/Tax/.test(requestType)){
              paymentRow.tbxTaxSubAmount["onTextChange"] = function(eventobject, context) {
                  this.view.TemplateRecordsNew.TabBodyNew.updateTotal(eventobject);
              }.bind(scope);
          }
          else{
              paymentRow.tbxAmount["onTextChange"] = function(eventobject, context) {
                  this.view.TemplateRecordsNew.TabBodyNew.updateTotal(eventobject);
              }.bind(scope);
          }
      });
      this.view.TemplateRecordsNew.TabBodyNew.segTemplates.setData(segDataTemp);
      if (/Tax/.test(requestType)) {
    ...
    getTRSectionData: function (requestType) {
      ...
      var sectionData = {
        ...
        lblAccountNumberKey: kony.i18n.getLocalizedString("i18n.ACH.accountNumber"),
    ...
    getAckTRSectionData: function (requestType) {
      ...
      var sectionData = {
        ...
        lblAccountNumberKey: {
          "text": kony.i18n.getLocalizedString("i18n.ACH.accountNumber"),
          "left": "8.2%",
          "width": "10%"
        },
        lblAccountTypeKey: {
    ...
    fetchTaxSubTypes: function (taxTypeId, eventobject, context) {
      ...
      this.loadACHModule().presentationController.getTaxSubTypes(navObj);
    },
    ...
    getTRCreateDefaultValues: function (requestType) {
      var defaultValues = {
        ...
        tbxCrAmount : {
          "onTextChange" : function(eventobject, context){
            this.view.TemplateRecordsNew.TabBodyNew.updateTotal(eventobject);
      ...
      if (/CCD|CTX|Web/.test(requestType)) {
        ...
        defaultValues = {
          ...
          btnRemoveSubCategory: {
            ...
            "isVisible": false,
            "onClick": function (eventobject, context) {
              this.view.TemplateRecordsNew.removeRowAndUpdateTotal(context.rowIndex, context.sectionIndex, ["tbxTaxSubAmount", "tbxAmount"]);
              this.view.forceLayout();
              this.adjustScreen(0);
            }.bind(this)
          },
...
//         CommonUtilities.disableButton(this.view.TemplateRecordsNew.TabBodyNew.getProceedWidget());
    ...
    getTrPaymentDefaultValues: function (requestType) {
      var ackDefaultValues = {
        ...
        btnRemoveRecord: {
          "text": kony.i18n.getLocalizedString("i18n.PayAPerson.payAPersonDeregister"),
          "isVisible": false,
          "left": (kony.application.getCurrentBreakpoint() === 1024) ? "94%" : "94.5%",
          "onClick": function (eventobject, context) {
    ...
    setValidationEventsForWidgets: function (UIType) {
      ...
      this.view.lstbRequestType.onSelection = function () {
        ...
        this.validateFormFields(UIType);
        this.view.lstbRequestType.skin = "sknLstbSelected";
      }.bind(this);
      ...
      this.view.lstbTemplateType.onSelection = function () {
        ...
        this.view.lstbTemplateType.skin = "sknLstbSelected";
        this.view.forceLayout();
      }.bind(this);

      this.view.tbxMaxAmt.onBeginEditing = function (tbxAmount) {
        if (!this.isTextNullOrUndefinedOrEmptyOrNonNumeric(tbxAmount.text)) {
          tbxAmount.text = applicationManager.getFormatUtilManager().deFormatAmount(tbxAmount.text, ",");
        }
      }.bind(this);
    },

    isTextNullOrUndefinedOrEmptyOrNonNumeric : function(text){
      if(kony.sdk.isNullOrUndefined(text) || text === "" || isNaN(text)){
        return true;
      }
      return false;
    },
    ...
    getRequestTypesOnSelection: function (selectedTemplateType, transactionTypeId, UIType) {
      ...
      this.loadACHModule().presentationController.getRequestTypes(navObj);
    ...
    initializeFromSegment: function (accounts) {
      ...
      if (applicationManager.getConfigurationManager().isMicroAppPresent("HomepageMA")) {
        ...
        responseAccounts = accountsModule.presentationController.accounts;
      }
    ...
    callGetCustomerActionLimits: function (featureAction, successScenario, failureScenario) {
      ...
      this.loadACHModule().presentationController.getCustomerActionLimits(navObj);
    },
    ...
    toggleErrorMessage: function (error, toShow, adjustScreenHeight) {
      if (toShow) {
        ...
        this.view.imgDisplayError.setVisibility(true);
        this.view.flxDisplayErrorMessage.setVisibility(true);
      } else {
        this.view.lblDisplayError.text = "";
        this.view.imgDisplayError.setVisibility(false);
    ...
    addTransactionRecords: function (UIType, templateParams, isEdit) {
      ...
      this.view.TemplateRecordsNew.lblCurrSymbol.text = applicationManager.getConfigurationManager().getCurrencyCode();
      ...
      var blankRow = {
        ...
        AccountNumber: {
          "placeholder": kony.i18n.getLocalizedString("i18n.ACH.accountNumber"),
          "text": ""
        },
        AccountType: {
    ...
    getACHSupportedFileTypes: function () {
      ...
      this.loadACHModule().presentationController.getSupportedFileTypes(navObj);
    },
    ...
    showFilesFromDevice: function () {
      ...
      var mimeString = this.loadACHModule().presentationController.getMIMEType(fileType);
    ...
    **/
    ...
    uploadACHFile: function (requestParam) {
      ...
      this.loadACHModule().presentationController.uploadACHFile(navObj);
    },
    ...
    fetchUploadedACHFile: function (requestParam) {
      ...
      this.loadACHModule().presentationController.getACHFileByID(navObj);
      FormControllerUtility.hideProgressBar(this.view);
      this.adjustScreen(0);
    },
    ...
    showACHFilesUpload: function () {
	  ...
	  this.view.filesFormActionsNew.btnNext.text = kony.i18n.getLocalizedString("i18n.konybb.common.Proceed");
      ...
      this.view.filesFormActionsNew.btnNext.onClick = function () {
        ...
        var FormatTypeID = scopeObj.loadACHModule().presentationController.validateFileFormatAndGetFormatTypeId(selectedFileType, uploadedFileType);
    ...
    fetchFileRecords: function (inputparams) {
      ...
      this.loadACHModule().presentationController.getACHFileRecords(navObj);
    },
    ...
    fetchTransactionRecords: function (inputparams) {
      ...
      this.loadACHModule().presentationController.getACHTransactionRecords(navObj);
    },
    ...
    invokeCreateTemplateService: function (inputparams, isEdit) {
      ...
      if (!kony.sdk.isNullOrUndefined(isEdit) && isEdit) {
        this.loadACHModule().presentationController.editACHTemplate(navObj);
      } else {
        this.loadACHModule().presentationController.createACHTemplate(navObj);
      }
    },
    ...
    invokeCreateTransactionService: function (inputparams) {
      ...
      this.loadACHModule().presentationController.createACHTransaction(navObj);
    },
    ...
    setTemplateRecordsForEdit: function (records) {
      ...
      if (records.isTaxType) {
        records.forEach(function (obj, index) {
          ...
          scopeObj.view.TemplateRecordsNew.TabBodyNew.segTemplates.data[0][1][index].tbxTaxSubAmount.text = data.Amount.text;
        ...
        records.forEach(function (obj, index) {
          ...
          scopeObj.view.TemplateRecordsNew.TabBodyNew.segTemplates.data[0][1][index].tbxCrAmount.text = data.Amount.text;
...
//       this.view.TemplateRecordsNew.TabBodyNew.enableOrDisableProceedWidget();
      CommonUtilities.enableButton(this.view.CommonFormActionsNew.btnOption);
//       this.view.CommonFormActionsNew.nextButton = this.view.CommonFormActionsNew.btnOption;
//       this.view.CommonFormActionsNew.enableNextButton();
      FormControllerUtility.hideProgressBar(this.view);
    },
    ...
    invokeExecuteTemplateService: function (inputparams) {
      ...
      this.loadACHModule().presentationController.executeTemplate(navObj);
    },
    ...
    showCreatedTransaction: function (response) {
      ...
      this.view.TemplateRecordsNew.lblTotalAmmount.right = "20%";
    ...
    /**
     * @todo - called in achFileViewDetails() - refactoring needed (must be removed)
     */
    ...
    /**
     * @todo - called in BBConstants.REQUEST_HISTORY_SUCCESS - will be removed when fetchRequestHistoryData() is removed
     */
      ...
      if (this.view.TemplateRecordsNew.TabBodyNew.isAllFieldsAreValid()) {
        ...
        if (totalAmount <= maxAmount) {
          ...
          this.displayErrorWhileExecutingTemplate(kony.i18n.getLocalizedString("i18n.konybb.ach.TotalAmountExceeding"), true);
            ...
            this.toggleErrorMessage(kony.i18n.getLocalizedString("i18n.konybb.common.ABA/TRCError"), true, 0)
            }
    },
    ...
    onBreakpointChange: function (width) {
      ...
      var breakPoint = width ? width : kony.application.getCurrentBreakpoint();
      var scope = this;
      var responsiveFonts = new ResponsiveFonts();
      this.view.customheader.onBreakpointChangeComponent(width);

      // hide dropdowns when the page is re-sized
      this.view.TabPaneNew.TabSearchBarNew.MobileCustomDropdown.flxDropdown.setVisibility(false);
      this.view.TabPaneNew.MobileCustomDropdown.flxDropdown.setVisibility(false);
      ...
      if (breakPoint === 640 || orientationHandler.isMobile) {
        ...
        if (this.view.flxTabPaneContainer.isVisible) {  // always visible
          this.view.flxDashboard.skin = "slFbox";
        } else {
          this.view.flxDashboard.skin = "slfBoxffffffB1R5";
        }
	  ...
	  if (breakPoint === 1366){
           this.view.flxContentContainer.width="100%";
      }
      this.adjustScreen(0);
      this.setMobileCustomDropDownVisibilityAndAlignment();
      // this.ACHModule = kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule("ACHUIModule");
    ...
    setMobileCustomDropDownVisibilityAndAlignment: function(){
	  ...
	  this.view.TabPaneNew.TabSearchBarNew.flxDropDown.top = "14dp";
      //this.view.TabPaneNew.TabSearchBarNew.flxDropDown.centerY = "47.5%";
      this.view.TabPaneNew.TabSearchBarNew.flxDropDown.width = "29%";
      this.view.TabPaneNew.TabSearchBarNew.flxDropDown.left = undefined;
      this.view.TabPaneNew.TabSearchBarNew.flxDropDown.right = "15dp";
      this.view.TabPaneNew.TabSearchBarNew.MobileCustomDropdown.height = "100%";
      this.view.TabPaneNew.TabSearchBarNew.MobileCustomDropdown.flxIphoneDropdown.left = "0dp";
      ...
      this.view.TabPaneNew.TabSearchBarNew.MobileCustomDropdown.flxDropdown.top = "40dp";
      ...
      this.view.TabPaneNew.TabSearchBarNew.MobileCustomDropdown.lblView.width = "19%";
      this.view.TabPaneNew.TabSearchBarNew.MobileCustomDropdown.lblView.left = "2%";
      this.view.TabPaneNew.TabSearchBarNew.MobileCustomDropdown.lblViewType.width = "75%";
      this.view.TabPaneNew.TabSearchBarNew.MobileCustomDropdown.lblViewType.left = "21%";
    ...
    showPopup: function (popupConfig, nextOnClick) {
      ...
      if (this.view.flxPopup.flxComments.isVisible === false) {
        this.view.flxPopup.formActionsNew.top = 10 + "dp";
        this.view.flxPopup.flxPopupContainer.height = "285px";
		this.view.flxPopup.formActionsNew.flxButtons.top = 5 + "dp"
      } else {
    ...
    fetchTermsAndConditionsForACH: function () {
      ...
      this.loadACHModule().presentationController.getACHTermsAndCondtions(navObj);
    },
    ...
    showAlert: function (popupConfig, nextOnClick) {
      ...
      this.view.flxPopup.top = "0dp";
      this.view.flxPopup.left = "0dp";
      this.view.flxPopup.width = "100%";
      this.view.flxPopup.height = "100%";
      this.view.flxPopup.flxPopupContainer.top = "0dp";
      this.view.flxPopup.flxPopupContainer.left = "0dp";
      this.view.flxPopup.flxPopupContainer.height = "290dp";
      this.view.flxPopup.flxPopupContainer.centerX = "50%";
      this.view.flxPopup.flxPopupContainer.centerY = "50%";
      this.view.flxPopup.formActionsNew.btnCancel.right = "20dp";
      this.view.flxPopup.lblHeader.text = popupConfig.header;
      this.view.flxPopup.lblPopupMsg.text = popupConfig.msg;
      this.view.flxPopup.flxComments.isVisible = popupConfig.commentsVisibility;
      this.view.flxPopup.formActionsNew.btnNext.text = popupConfig.nextText;
    ...
    deleteACHTemplate: function (Template_id) {
      ...
      this.loadACHModule().presentationController.deleteACHTemplates(navObj);
    },
    ...
    /**
     * @description Service call for getRequestHistory for signatory groups
     */
