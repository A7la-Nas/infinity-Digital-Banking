define(['FormControllerUtility'], function(FormControllerUtility) {
  ...
  return {
    ...
    frmPreShow: function() {
      ...
      this.view.deletepopup.formActionsNew.btnCancel.text = kony.i18n.getLocalizedString("i18n.SignatoryMatrix.No");
      this.view.deletepopup.formActionsNew.btnNext.text = kony.i18n.getLocalizedString("i18n.common.next");
      this.conditionCount = {};
      this.conditionFlex = [];
      ...
      this.view.confirmpopup.imgClose.onTouchEnd = this.dismissConfirmPopup;
      ...
      this.view.btnCancel.onClick = function(){
        ...
        scope.view.cancelpopup.formActionsNew.btnNext.text= kony.i18n.getLocalizedString("i18n.SignatoryMatrix.Yes");
        scope.view.cancelpopup.formActionsNew.btnCancel.text=kony.i18n.getLocalizedString("i18n.SignatoryMatrix.No");
        scope.view.cancelpopup.lblPopupMsg.text=kony.i18n.getLocalizedString("i18n.SignatoryMatrix.Changesyoumademaynotbesaveddoyouwanttodiscardthechanges");
        scope.view.cancelpopup.lblHeader.text=kony.i18n.getLocalizedString("i18n.transfers.Cancel");
    ...
    nonMonetaryEditData:function(){
      this.view.lblViewEditCondition.text = kony.i18n.getLocalizedString("i18n.SignatoryMatrix.ViewEditConditionBelow");
    ...
    deleteEntireAction:function(){
      ...
      this.prevCurrenctCondition = "";
      this.prevdropDownName = "";
      this.view.lblAckNotificationContent.text = kony.i18n.getLocalizedString("kony.18n.approvalMatrix.conditiondeleted");
    ...
    showErrorMessage: function(error) {
      ...
      this.view.rtxDowntimeWarning.text = (error && error.errorMessage) ? error.errorMessage : kony.i18n.getLocalizedString("i18n.common.OoopsServerError");
      this.view.forceLayout();
    },
    ...
    deletePopupEnable:function(flexType,sectionCount,currentCondition){
      ...
      this.view.deletepopup.formActionsNew.btnNext.text=kony.i18n.getLocalizedString("i18n.transfers.deleteExternalAccount");
      this.view.deletepopup.formActionsNew.btnCancel.text= kony.i18n.getLocalizedString("i18n.SignatoryMatrix.No");
      ...
      if(flexType === "section"){
        this.view.deletepopup.formActionsNew.btnNext.onClick = function(){
          ...
          scope.view.lblAckNotificationContent.text = kony.i18n.getLocalizedString("kony.18n.approvalMatrix.conditiondeleted");
        ...
        this.view.deletepopup.flxBody.formActionsNew.btnNext.text=kony.i18n.getLocalizedString("i18n.transfers.deleteExternalAccount");
        this.view.deletepopup.flxBody.formActionsNew.btnCancel.text=kony.i18n.getLocalizedString( "i18n.SignatoryMatrix.No");
        this.view.deletepopup.formActionsNew.btnNext.onClick = function(){
    ...
    createApprovalConditionSection: function(sectionCount){
      ...
      var lblConditoinHdr = new kony.ui.Label({
        ...
        "text": kony.i18n.getLocalizedString("i18n.SignatoryMatrix.Condition")+ stackRows.length,
        "left":"20dp",
        "height": kony.flex.USE_PREFERRED_SIZE,
        "width": kony.flex.USE_PREFERRED_SIZE,
        "top":"20dp"
    ...
    addNewANDCondition:function(sectionCount){
      ...
      var lblRequiredApprovalsCount = new kony.ui.Label({
        ...
        "text": kony.i18n.getLocalizedString("i18n.SignatoryMatrix.SelectCount"),
        "left":"15dp",
        "height": kony.flex.USE_PREFERRED_SIZE,
        "width": kony.flex.USE_PREFERRED_SIZE,
        "centerY":"50%"
      ...
      var lblFromGroupSelectedVal = new kony.ui.Label({
        ...
        "isVisible": true,
        "skin": "bbSknLbl424242SSP15Px",
        "text": kony.i18n.getLocalizedString("i18n.SignatoryMatrix.SelectGroup"),
        "left":"15dp",
        "height": kony.flex.USE_PREFERRED_SIZE,
        "width": kony.flex.USE_PREFERRED_SIZE,
        "centerY":"50%"
