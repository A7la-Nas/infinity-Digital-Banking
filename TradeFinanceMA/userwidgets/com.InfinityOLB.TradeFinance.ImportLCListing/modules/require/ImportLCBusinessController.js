define(['DataFormattingUtils/FormatUtils','InvokeServiceUtils','CommonUtilities'],function(FormatUtils,InvokeServiceUtils,CommonUtilities) {
  ...
  BusinessController.prototype.getMetaData = function() {
    ...
    function getMetaDataSuccess(response) {
      ...
      objectMetadata = {"chargesPaid":{"validation":"AMOUNT","format":"AMOUNT","formatting_dependency":"lcCurrency"},"amendmentApprovedDate":{"validation":"DATE","format":"DATE"},"amendmentDate":{"validation":"DATE","format":"DATE"},"issueDate":{"validation":"DATE","format":"DATE"},"lcCreatedOn":{"validation":"DATE","format":"DATE"},"expiryDate":{"validation":"DATE","format":"DATE"},"lcAmount":{"validation":"AMOUNT","format":"AMOUNT","formatting_dependency":"lcCurrency"},"documentCharges":{"validation":"AMOUNT","format":"AMOUNT","formatting_dependency":"lcCurrency"},"additionalAmountPayable":{"validation":"AMOUNT","format":"AMOUNT","formatting_dependency":"lcCurrency"},"drawingCreationDate":{"validation":"DATE","format":"DATE"},"drawingAmount":{"validation":"AMOUNT","format":"AMOUNT","formatting_dependency":"lcCurrency"}};
    ...
    kony.mvc.util.ProcessorUtils.getMetadataForObject(this.serviceParameters.Service, this.serviceParameters.Object, options, getMetaDataSuccess, getMetaDataFailure);
  }; 
  /**
  ...
  BusinessController.prototype.getMetaDataFromModel = function(service, object) {
    ...
    var objectMetadata;
    if(object === "objName") {
      objectMetadata =  {"amendmentDate":{"validation":"DATE","format":"DATE"},"lcReferenceNo":{"validation":"ID_ALPHANUMERIC"},"lcAmount":{"validation":"AMOUNT_FORMAT"},"expiryPlace":{"validation":"NAME"}};
    }    
