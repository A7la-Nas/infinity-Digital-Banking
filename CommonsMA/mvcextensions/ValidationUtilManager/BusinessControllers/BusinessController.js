...
define([], function() {
  ...
  function ValidationUtilManager(){
    /*this.taxIdregex =  /^[0-9a-zA-Z\u0600-\u06FF]+$/;
    this.phoneNumberRegex = /^([0-9]){7,15}$/;	
    this.countryCodeRegex = /^\+{1}[0-9]+$/g;
    this.phoneNumberCountryCodeRegex = /^(\+?\d{1,3}|\d{1,4})$/gm;
    this.ssnRegex = /[^a-zA-Z0-9\u0600-\u06FF ]/;
    this.passwordRegex = /^(?=.*\d)(?=.*[a-z\u0600-\u06FF])(?=.*[A-Z\u0600-\u06FF]).*$/;
    this.invalidChar = "&%<>\/\+'=|\\" ;
    this.zipRegex = /^[^-_][a-zA-Z0-9\u0600-\u06FF\s-]*[a-zA-Z0-9\u0600-\u06FF\s]+$/;
    this.usernameRegex = /^[A-Za-z0-9\u0600-\u06FF_]+$/;
    this.benificiaryNameRegex = /^[A-Za-z0-9\u0600-\u06FF ]+$/;
    this.urlRegex=/^(http:\/\/www\.|https:\/\/www\.|http:\/\/|https:\/\/|www\.)[a-z0-9\u0600-\u06FF]+([\-\.]{1}[a-z0-9\u0600-\u06FF]+)*\.[a-z\u0600-\u06FF]{2,5}(:[0-9]{1,5})?(\/.*)?$/;
    this.drivingLicenseRegex = /^[0-9a-zA-Z\u0600-\u06FF]*$/;
    this.alphaNumeric=/^[a-z\d\u0600-\u06FF\-_\s]+$/i;*/
