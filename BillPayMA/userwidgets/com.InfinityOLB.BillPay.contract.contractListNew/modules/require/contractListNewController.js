define(['./ParserUtilsManager'], function (ParserUtilsManager) {
  ...
  return {
    ...
    //   if(this._context === true){    
    //     this.view.btnAction4.setActive(true);
    //     this._context = false;
    //   }
    //   else{
...
//         else{}
    ...
    initializeSortActions: function() {
      ...
      this.view.flxCol1.accessibilityConfig = {
        "a11yLabel":this.view.lblCol1.text+" column sorted in ascending order. click to sort in descending order",
        "a11yARIA":{
          "role":"button",
          "tabindex":0
        }
      ...
      this.view.flxCol2.accessibilityConfig = {
        "a11yLabel":this.view.lblCol2.text+" column, no sort applied.click to sort in ascending order",
        "a11yARIA":{
          "role":"button",
          "tabindex":0
        }
    ...
    setDataForContracts: function (data, editData) {
      ...
      for (var i = 0; i < dataGridResponse.length; i++) {
        ...
        headerDataRecord["flxDropdown"] = {
          ...
          "accessibilityConfig":{
            "a11yLabel":"show more details for contract "+dataGridResponse[i][JSON.parse(scope._column1)["mapping"]],
            "a11yARIA":{
              "aria-expanded":false,
              "tabindex":0,
              "role":"button"
        ...
        if (column1Visibility) {
          ...
          headerDataRecord["lblContract1"] = {
            "text": scope.view.lblCol1.text+" "+dataGridResponse[i][JSON.parse(scope._column1)["mapping"]]
          };
        } else {
          headerDataRecord["lblContract"] = {
            "isVisible": false
        ...
        if (column2Visibility) {
          ...
          headerDataRecord["lblIdentityNumber1"] = {
            "text": scope.view.lblCol2.text+" "+dataGridResponse[i][JSON.parse(scope._column2)["mapping"]]
          };
        } else {
          headerDataRecord["lblIdentityNumber"] = {
            "isVisible": false
        ...
        headerDataRecord["lblCIF"] = {
          "text": "0 " + kony.i18n.getLocalizedString("i18n.unifiedBeneficiary.of") + " "+ dataGridResponse[i].contractCustomers.length
        };
        headerDataRecord["lblCIF1"] = {
          "text": scope.view.lblColumn3.text+" "+"0 " + kony.i18n.getLocalizedString("i18n.unifiedBeneficiary.of") + " "+ dataGridResponse[i].contractCustomers.length
        };
...
this.view.segContract.setActive(context.rowIndex,context.sectionIndex,"flxContractsCollapsedMobile.flxMainGroup.flxGroup.flxContractsCollapsedWrapper.flxDropdown");
},

    toogleRowCheckBox: function (widgetInfo,context) {

      let data = this.view.segContract.data;
      let selectedRowIndex;

      if (widgetInfo != undefined && widgetInfo >= 0) {
        selectedRowIndex = widgetInfo;
      } else {
      ...
      if (data[selectedRowIndex][0].lblCheckBoxSelect.text === "D") {
        ...
        data[selectedRowIndex][1].forEach(x => x.flxCustomerCheckbox.accessibilityConfig = {
          "a11yARIA":{
            "aria-labelledby":"lblCustomerName",
            "role":"checkbox",
            "aria-checked":true
      ...
      this.view.segContract.setActive(context.rowIndex,context.sectionIndex,"flxContractsCollapsedMobile.flxMainGroup.flxGroup.flxContractsCollapsedWrapper.flxHeader.flxRowCheckBox.flxCheckBox");
    },
    ...
    toogleCustomerCheckBox: function (widgetInfo,context) {
      ...
      data[selectedRowIndex][1].forEach(x => {
        if (x.lblCustomerCheckbox.text === "C") {
          if (data[selectedRowIndex][0].lblCheckBoxSelect.text !== "C") {
            data[selectedRowIndex][0].lblCheckBoxSelect.text = "C";
            data[selectedRowIndex][0].flxCheckBox.accessibilityConfig = {
              "a11yARIA": {
                "aria-labelledby": "lblContract",
      ...
      this.view.segContract.setActive(context.rowIndex,context.sectionIndex,"flxContractsCollapsedMobile.flxMainGroup.flxGroup.flxCustomer.flxCustomerDetails.flxCustomerCheckbox");
    },
    ...
    toogleSelectAllCheckBox: function () {
      ...
      if (this.view.lblCheckBoxSelectAll.text === "D") {
        ...
        data.forEach((x, i) => {
          ...
          let customerLength = data[i][1].length;
          data[i][0].lblCheckBoxSelect.text = "C";
          data[i][0].flxCheckBox.accessibilityConfig={
            "a11yARIA":{
              "aria-labelledby":"lblContract",
              "role":"checkbox",
              "aria-checked":true,
          ...
          data[i][0].lblCIF.text = customerLength + " " + kony.i18n.getLocalizedString("i18n.unifiedBeneficiary.of") + " " + customerLength;
          data[i][1].forEach(x => x.lblCustomerCheckbox.text = "C");
          data[i][1].forEach(x => x.flxCustomerCheckbox.accessibilityConfig = {
            "a11yARIA":{
              "aria-labelledby":"lblCustomerName",
              "role":"checkbox",
              "aria-checked":true,
        ...
        data.forEach((x, i) => {
          ...
          //this.toogleRowCheckBox(i)
          let customerLength = data[i][1].length;
          data[i][0].lblCheckBoxSelect.text = "D";
          data[i][0].flxCheckBox.accessibilityConfig={
            "a11yARIA":{
              "aria-labelledby":"lblContract",
              "role":"checkbox",
          ...
          data[i][0].lblCIF.text = 0 + " " + kony.i18n.getLocalizedString("i18n.unifiedBeneficiary.of") + " " + customerLength;
          data[i][1].forEach(x => x.lblCustomerCheckbox.text = "D")
          data[i][1].forEach(x => x.flxCustomerCheckbox.accessibilityConfig = {
            "a11yARIA":{
              "aria-labelledby":"lblCustomerName",
              "role":"checkbox",
    ...
    sortByContractName: function() {
      ...
      if(scopeObj.view.imgCol1.src === "sorting_next.png") {
        ...
        scopeObj.view.flxCol1.accessibilityConfig = {
          "a11yLabel":scopeObj.view.lblCol1.text+" column sorted in ascending order.click to sort in descending order",
          "a11yARIA":{
            "role":"button",
            "tabindex":0
          }
        ...
        scopeObj.view.flxCol1.accessibilityConfig = {
          "a11yLabel":scopeObj.view.lblCol1.text+" column sorted in descending order.click to sort in ascending order",
          "a11yARIA":{
            "role":"button",
            "tabindex":0
          }
      ...
      scopeObj.view.flxCol2.accessibilityConfig = {
        "a11yLabel":scopeObj.view.lblCol2.text+" column, no sort applied.click to sort in ascending order",
        "a11yARIA":{
          "role":"button",
          "tabindex":0
        }
    ...
    sortByIdentityNumber: function() {
      ...
      if(scopeObj.view.imgCol2.src === "sorting_next.png") {
        ...
        scopeObj.view.flxCol2.accessibilityConfig = {
          "a11yLabel":scopeObj.view.lblCol2.text+" column sorted in ascending order.click to sort in descending order",
          "a11yARIA":{
            "role":"button",
            "tabindex":0
          }
        ...
        scopeObj.view.flxCol2.accessibilityConfig = {
          "a11yLabel":scopeObj.view.lblCol2.text+" column sorted in descending order.click to sort in ascending order",
          "a11yARIA":{
            "role":"button",
            "tabindex":0
          }
      ...
      scopeObj.view.flxCol1.accessibilityConfig = {
        "a11yLabel":scopeObj.view.lblCol1.text+" column, no sort applied.click to sort in ascending order",
        "a11yARIA":{
          "role":"button",
          "tabindex":0
        }
      ...
      scopeObj.view.segContract.setData(data);
      scopeObj.view.forceLayout();
      scopeObj.view.flxCol2.setActive(true);
    },
