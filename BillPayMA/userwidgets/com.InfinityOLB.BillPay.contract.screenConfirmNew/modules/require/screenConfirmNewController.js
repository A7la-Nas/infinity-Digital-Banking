  ...
  return {
    ...
    */
    ...
    initializeSortActions: function () {
      ...
      scopeObj.view.flxColumn1.onClick = scopeObj.onSortClick.bind(scopeObj,scopeObj.view.flxColumn1, scopeObj.view.imgSortColumn1, JSON.parse(scopeObj._column1).sortBy, JSON.parse(scopeObj._column1).sortByType);
      scopeObj.view.flxColumn2.onClick = scopeObj.onSortClick.bind(scopeObj,scopeObj.view.flxColumn2, scopeObj.view.imgSortColumn2, JSON.parse(scopeObj._column2).sortBy, JSON.parse(scopeObj._column2).sortByType);
      scopeObj.view.flxColumn1.accessibilityConfig = {
        "a11yLabel": `${scopeObj.view.lblColumn1.text} Column Sorted in Descending order Click to Sort in Ascending order`,
        "a11yARIA": {
          "role": "button",
          "tabindex": 0
        }
      ...
      scopeObj.view.flxColumn2.accessibilityConfig = {
        "a11yLabel": `${scopeObj.view.lblColumn2.text} Column No Sort applied Click to sort in Asceding order`,
        "a11yARIA": {
          "role": "button",
          "tabindex": 0
        }
        ...
        if (element[0].lblCheckBoxSelect.text === "C") {
          ...
          headerData.push({
            "flxDropDown": {
              ...
              "accessibilityConfig": {
                "a11yLabel": `Show more details for the contract with the identity number ${column2Visibility ? element[0][JSON.parse(scopeObj._column2)["mapping"]].text : ""}`,
                "a11yARIA": {
                  "role": "button",
                  "tabindex": 0,
                  "aria-expanded": false
            ...
            "lblColumn1Accessibility": {
              "text": column1Visibility ? scopeObj.view.lblColumn1.text+" "+element[0][JSON.parse(scopeObj._column1)["mapping"]].text : "",
              "isVisible": column1Visibility
            },
            "lblColumn2": {
            ...
            "lblColumn2Accessibility": {
              "text": column2Visibility ? scopeObj.view.lblColumn2.text+" "+element[0][JSON.parse(scopeObj._column2)["mapping"]].text : "",
              "isVisible": column2Visibility
            },
            "lblColumn3": {
            ...
            "lblColumn3Accessibility": {
              "text": column3Visibility ? scopeObj.view.lblColumn3.text+" "+element[0][JSON.parse(scopeObj._column3)["mapping"]].text : "",
              "isVisible": column3Visibility
            },
            "template": kony.application.getCurrentBreakpoint() === 640
              ? "flxContractConfirmScreenRowTemplateMobile"
    ...
    onClickRowExpand: function (widgetInfo,context) {
      ...
      if (data[selectedRowIndex][0].lblDropdown.text === "O") {
        ...
        data[selectedRowIndex][0].flxDropDown.accessibilityConfig = {
          "a11yLabel": `Hide details for the contract with the identity number ${data[selectedRowIndex][0].lblColumn2.text}`,
          "a11yARIA": {
            "role": "button",
            "tabindex": 0,
            "aria-expanded": true
        ...
        data[selectedRowIndex][0].flxDropDown.accessibilityConfig = {
          "a11yLabel": `Show more details for the contract with the identity number ${data[selectedRowIndex][0].lblColumn2.text}`,
          "a11yARIA": {
            "role": "button",
            "tabindex": 0,
            "aria-expanded": false
      ...
      if(kony.application.getCurrentBreakpoint() !== 640){
        scopeObj.view.segContracts.setActive(context.rowIndex, context.sectionIndex, "flxContractConfirmScreenRowTemplate.flxMaingroup.flxGroup.flxUserCommonRowHeader.flxContent.flxDropDown");
      }
      else{
        scopeObj.view.segContracts.setActive(context.rowIndex, context.sectionIndex, "flxContractConfirmScreenRowTemplateMobile.flxMaingroup.flxGroup.flxUserCommonRowHeader.flxDropDown");
      }
    },
     ...
     */
    onSortClick: function (flxWidget, widget, sortColumn, sortByType) {
      var scopeObj = this;
      ...
      if (sortColumn === "lblColumn1") {
        ...
        scopeObj.view.flxColumn1.accessibilityConfig = {
          "a11yLabel": `${scopeObj.view.lblColumn1.text} Column No Sort applied Click to sort in Asceding order`,
          "a11yARIA": {
            "role": "button",
            "tabindex": 0
          }
      ...
      var widgetId = widget.id === "imgSortColumn1" ?
        { "parentFlex": "flxColumn1", "widgetText": "lblColumn1" } :
        { "parentFlex": "flxColumn2", "widgetText": "lblColumn2" };
      if (widget.src === scopeObj._iconColumnSortAsc) {
        widget.src = scopeObj._iconColumnSortDsc;
        sortOrder = "DESC";
        scopeObj.view[widgetId.parentFlex].accessibilityConfig = {
          "a11yLabel": `${scopeObj.view[widgetId.widgetText].text} Column Sorted in Descending order Click to Sort in Ascending order`,
          "a11yARIA": {
            "role": "button",
            "tabindex": 0
          }
        ...
        sortOrder = "ASC";
        scopeObj.view[widgetId.parentFlex].accessibilityConfig = {
          "a11yLabel": `${scopeObj.view[widgetId.widgetText].text} Column Sorted in Ascending order Click to Sort in Descending order`,
          "a11yARIA": {
            "role": "button",
            "tabindex": 0
          }
      ...
      scopeObj.view[widgetId.widgetText].setActive(true);
      scopeObj.view.segContracts.setData(data);
      scopeObj.view.forceLayout();
      flxWidget.setActive(true);
    },
