define(["CommonUtilities","OLBConstants"], function (CommonUtilities,OLBConstants){
  return{
    ...
    init: function(){
      ...
      this.view.flxExistingUser.onTouchStart = this.showExistingLogin;
      this.view.flxExploreProducts.onTouchStart = this.onClickExploreProducts;
      this.view.flxResumeApp.onTouchStart = this.onClickResumeApplication;
      this.initActions();
    },
    frmLoginPostshow: function() {
      ...
      if (multiEntityValue === "true") {
        this.view.lblEnroll.text = kony.i18n.getLocalizedString("i18n.Login.Activate");
      }else {
        this.view.lblEnroll.text = kony.i18n.getLocalizedString("i18n.Login.EnrollActivate");
        //this.view.lblEnroll.text = kony.i18n.getLocalizedString("i18n.Login.Activate");
      }
      this.view.btnEnroll.onClick = this.navToActivate;
      this.view.btnEnroll.info = this.view.lblEnroll.text;
    ...
    initActions: function(){
      this.view.flxLanguageSelection.onTouchStart = this.showLanguages;
   ...
   //  start osama
    ...
    //end osama
    showExistingLogin: function(){
      var authMode = kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule("AuthUIModule");
      authMode.presentationController.isloginFormShown = true;
      this.view.flxNewLogin.setVisibility(false);
      this.view.login.setVisibility(true);
      this.view.flxCampaignsWrapper.setVisibility(true);
      this.view.lblWelcomeMessage.text = kony.i18n.getLocalizedString("i18n.login.Welcome");
    },
    onClickExploreProducts: function(){
        const configManager = applicationManager.getConfigurationManager();
        kony.application.openURL(configManager.getExploreProductsUrl());
    },
    onClickResumeApplication: function(){
        //osama
       // const configManager = applicationManager.getConfigurationManager();
      //  kony.application.openURL(configManager.getResumeApplUrl());
      kony.application.openURL("https://www.firstaden-bank.com/FADBankOnline");

    },
    showNewLogin: function(){
      this.view.flxNewLogin.setVisibility(true);
      this.view.lblWelcomeMessage.text = kony.i18n.getLocalizedString("i18n.login.Welcome");
      this.view.login.setVisibility(false);
      this.view.flxCampaignsWrapper.setVisibility(false);
    },
    ...
    showLanguages : function(){
      ...
      if(this.view.imgDropdown.src === "arrowupblue.png"){
        self.view.imgDropdown.src = "arrow_down.png";
        self.HideLanguages();
      } else {
        this.view.imgDropdown.src = "arrowupblue.png";
...
//         });
    ...
    resetLoginUI : function (){
      ...
      this.view.imgKonyLogo.height = "155dp";
    ...
    loginFunctionalPreshow: function() {      
      ...
      if (navData && !(navData.isFirstTimeLoginUname) && (navData.isRememberMeOn) && (navData.userName)){
        ...
        this.view.lblWelcomeMessage.text = kony.i18n.getLocalizedString("kony.mb.Welcome")+" "+kony.i18n.getLocalizedString("kony.mb.login.back")+" "+firstname;
    ...
    frmLoginPreShow:function(){
      var authMode = kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule("AuthUIModule");
      if(authMode.presentationController.isloginFormShown && this.view.login.isVisible){
        this.showExistingLogin();
      }else if(authMode.presentationController.isNewLogintobeShown){
        var sm = applicationManager.getStorageManager();
    ...
    tbxOnTouchStart: function() {
      ...
      //this.animateImgKonyLogoOnTouch("25dp");//osama
      this.animateImgKonyLogoOnTouch("155dp");
    },
