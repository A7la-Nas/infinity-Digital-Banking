define(['./FomatValueUtils'],function(FomatValueUtils){
  ...
  return {
    ...
    formatText : function(){
      ...
      if(this._FieldType){
        if(this._FieldType.type == "Label"){
          ...
          if(!kony.sdk.isNullOrUndefined(amount) || isNaN(amount)){
    ...
    setTextToEyeIcon: function (data) {
      ...
      if (data === "h") {
        if (this._FieldType.type == "Account Number") {
    ...
    setAccessibility: function(){
      this.view.flxData.accessibilityConfig = {
        "a11yARIA": {
          tabindex: -1
        }
      }
      this.view.lblIconStart.accessibilityConfig={
        "a11yHidden": true,
        "a11yARIA": {
          tabindex: -1
        }
      }
      this.view.flxAnimate.accessibilityConfig = {
        "a11yARIA": {
          tabindex: -1
        }
      }
      this.view.imgGlow.accessibilityConfig={
        "a11yHidden": true,
        "a11yARIA": {
          tabindex: -1
        }
