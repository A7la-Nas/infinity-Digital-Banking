  ...
  return {
    ...
    postShow: function() {
      ...
      this.view.customheader.btnSkip.onClick = function () {  
        scopeObj.view.lblCustomView.setActive(true);
      }
    ...
    /**
     * used to implement Escape functionality to signout popup for accessibility
     *
     */
    ...
    onKeyPressCallBack: function (eventObject, eventPayload) {
      if (eventPayload.keyCode === 27) {
        ...
        if (this.view.flxDelete.isVisible === true) {
          this.setDeletePopupNo();
        }
      }
    },
    ...
    accessibilityFocusSetup: function() {
      this.view.txtCustomViewName.accessibilityConfig = {
        a11yARIA: {
          "tabindex": 0,
      ...
      this.view.deletePopup.lblHeading.accessibilityConfig = {
        a11yARIA: {
          "tabindex": -1
        }
      }
      this.view.deletePopup.accessibilityConfig = {
        a11yARIA: {
          "tabindex": -1,
          "role": "dialog"
        }
      }
      this.view.deletePopup.flxCross.accessibilityConfig = {
        a11yLabel:"Close delete custom view dialog",
        a11yARIA: {
          "tabindex": 0,
          "role": "button"
        }
      }
      this.view.deletePopup.btnYes.accessibilityConfig = {
        a11yLabel:"Yes, delete custom view",
        a11yARIA: {
          "tabindex": 0,
          "role": "button"
        }
      }
      this.view.deletePopup.btnNo.accessibilityConfig = {
        a11yLabel:"No, donot delete custom view",
        a11yARIA: {
          "tabindex": 0,
          "role": "button"
        }
      ...
      this.view.btnCancel.accessibilityConfig = {
        a11yLabel:"cancel create custom view process",
        a11yARIA: {
          "tabindex": 0,
          "role": "button"
        }
      }
      this.view.btnCreate.accessibilityConfig = {
        a11yLabel:"create and apply custom view",
        a11yARIA: {
          "tabindex": 0,
          "role": "button"
        }
    ...
    showCreateCustomView: function() {
      ...
      this.view.txtCustomViewName.placeholder = kony.i18n.getLocalizedString("kony.tab.billpay.enterName");
        ...
        if (this.view.txtCustomViewName.text.length <= 50 && this.view.txtCustomViewName.text.length > 0) {
          ...
          for (i = 0, len = str.length; i < len; i++) {
            ...
            if (!(code > 47 && code < 58) && // numeric (0-9)
              ...
              this.view.lblAvailability.text = kony.i18n.getLocalizedString("i18n.customViews.inValid");
              ...
              this.view.flxStatus.setVisibility(true);
              this.view.lblAvailability.text = kony.i18n.getLocalizedString("i18n.customViews.valid");
          ...
          this.view.flxtxtCVName.skin = "bbSknFlxBorderFF0000Radius3Px";
          this.view.lbltxtCustomViewNameValid.setVisibility(true);
          this.view.lbltxtCustomViewNameValid.text = kony.i18n.getLocalizedString("i18n.customViews.enterValidCustomName");
          this.view.flxtxtCustomViewName.top = "15dp";
          this.view.flxStatus.setVisibility(false);
        }  
      }
    ...
    setCreateCustomViewData: function() {
      ...
      if (this.view.lbltxtCustomViewNameValid.text === kony.i18n.getLocalizedString("i18n.customViews.valid")) {
        this.view.flxtxtCVName.skin = "sknBorderE3E3E3";
         var param = {
         ...
         if (custDashboard === "true") {
           ...
           param.coreCustomerId = CustomerId;           
         }    
    ...
    showEditCustomView: function(response) {
      ...
      var custDashboard = accountsModule.presentationController.customerdashboard;
      var accountsEdit = null;
      if (custDashboard === "true") {
           accountsEdit = this.presenter.presentationController.customeraccounts;
      } else {
           accountsEdit = this.presenter.presentationController.accounts;
      }
    ...
    setDeletePopup: function() {
      ...
      this.view.flxDelete.isModalContainer = true;  
      this.view.deletePopup.lblHeading.setActive(true);        
    },
    setDeletePopupNo: function() {
      this.view.flxDelete.setVisibility(false);
      this.view.btnDelete.setActive(true);
    },
    ...
    setCustomViewsSegmentData: function(accounts) {
      ...
      if (accounts.length > 0) {
        ...
        this.view.lblScheduleAPayment.text = kony.i18n.getLocalizedString("i18n.konybb.NoAccountNameNumberFound");
    ...
    showError: function(errorMsg) {
      if (errorMsg) {
        this.view.flxDowntimeWarning.setVisibility(true);
        this.view.lblDowntimeWarning.text = errorMsg;
        this.view.lblDowntimeWarning.setFocus(true);
      } else {
        this.view.flxDowntimeWarning.setVisibility(false);
      }
        ...
        if (finalData.hasOwnProperty(accountType)) {
          ...
          finalData[accountType] = [{
            ...
            flxChecked: {
              ...
              "accessibilityConfig": {
                a11yLabel:applicationManager.getTypeManager().getAccountTypeDisplayValue(accountType) != undefined ? "Select all "+ applicationManager.getTypeManager().getAccountTypeDisplayValue(accountType) : "Select all "+ accountType + " " + kony.i18n.getLocalizedString("i18n.topmenu.accounts"),
                "a11yARIA": {
                  "tabindex": 0,
                  "role": "checkbox",
                  "aria-checked": false
            ...
            lblSelectAll: {
              text: kony.i18n.getLocalizedString("konybb.i18n.selectAll")
            },
            lblTopSeparator: {
              "isVisible": true
            },
        ...
        if (finalData.hasOwnProperty(accountType) && account.Membership_id === finalData[accountType][0]["membershipId"]) {
          ...
          finalData[accountType] = [{
            ...
            flxChecked: {
              ...
              "accessibilityConfig":{
                a11yLabel:accountType === "Personal Accounts" ? "Select all "+ accountType : "Select all "+ account.MembershipName,
                  "a11yARIA":{
                      "tabindex":0,
                      "role":"checkbox",
                      "aria-checked":false
            ...
            flxDropDown: {
              ...
              "accessibilityConfig":{
                a11yLabel: accountType === "Personal Accounts" ? accountType : account.MembershipName,
                  "a11yARIA":{
                      "tabindex":0,
                      "role":"button",
                      "aria-expanded":true
    ...
    */
      ...
      if (!kony.sdk.isNullOrUndefined(account1)) {
        dataObject = {          
          ...
          "flxChecked": {
            ...
            "accessibilityConfig": {
              a11yLabel: this.formatAccountName(account),
              "a11yARIA": {
                "tabindex": 0,
                "role": "checkbox",
                "aria-checked": false
          ...
          "flxChecked1": {
            ...
            "accessibilityConfig":{
                a11yLabel: this.formatAccountName(account1),
                "a11yARIA":{
                    "tabindex":0,
                    "role":"checkbox",
                    "aria-checked":false
    ...
    showOrHideAccountRows: function(context) {
      ...
      if (segData[section][0].lblDropDown.text === "O") {
        ...
        segData[section][0]["flxDropDown"].accessibilityConfig = {
          "a11yLabel":segData[section][0].lblAccountTypeHeader.text,
          "a11yARIA": {
            "tabindex": 0,
            "role": "button",
            "aria-expanded": true
      ...
      for (var i = 0; i < segData[section][1].length; i++) {
        ...
        if (isRowVisible === false) {
          if (kony.application.getCurrentBreakpoint() === 640 || orientationHandler.isMobile) {
            ...
            flxAccountsListCustomView["isVisible"] = false;
          ...
          if (kony.application.getCurrentBreakpoint() === 640 || orientationHandler.isMobile) {
            ...
            flxAccountsListCustomView["isVisible"] = true;
            this.updateKeyAt("flxAccountsListCustomViewMobile", flxAccountsListCustomView, i, section);
          } else {
            flxAccountsListCustomView = JSON.parse(JSON.stringify(segData[section][1][i].flxAccountsListCustomView));
      ...
      // this.view.segCustomViews.sectionHeaderTemplate === "flxAccountsHeaderCustomViewMobile"
      if (kony.application.getCurrentBreakpoint() === 640 || orientationHandler.isMobile) {
        this.view.segCustomViews.setActive(-1, section, "flxAccountsHeaderCustomViewMobile.flxHeaderWrapper.flxGrpHeader.flxDropDown");
      }
      else {
        this.view.segCustomViews.setActive(-1, section, "flxAccountsHeaderCustomView.flxHeaderWrapper.flxDropDown");
    }
      this.view.forceLayout();
    },
    ...
    toggleCheckBox: function() {
      ...
      if (segData[section][1][row].imgChecked.text === OLBConstants.FONT_ICONS.CHECBOX_SELECTED) {
        segData[section][1][row].flxChecked.accessibilityConfig = {
          a11yLabel: segData[section][1][row].lblAccountName,
          "a11yARIA": {
            "tabindex": 0,
            "role": "checkbox",
            "aria-checked": true
        ...
        this.accountsFlag++;
        if (this.accountsFlag >= 1 && this.view.lblAvailability.text !== 'InValid' && this.view.txtCustomViewName.text.length > 0 && !(this.view.lbltxtCustomViewNameValid.isVisible))
          FormControllerUtility.enableButton(this.view.btnCreate);
        else 
          FormControllerUtility.disableButton(this.view.btnCreate);
      } else {
        ...
        if (segData[section][0].imgChecked.text === "C") {
          ...
          segData[section][0].flxChecked.accessibilityConfig = {
            a11yLabel: "Select all "+segData[section][0].lblAccountTypeHeader.text,
            "a11yARIA": {
              "tabindex": 0,
              "role": "checkbox",
              "aria-checked": false
      ...
      accountsCheckBox.forEach(function(item) {
        if (segData[section][1][row].imgChecked.text === OLBConstants.FONT_ICONS.CHECBOX_SELECTED) { 
          if (item.accountID === segData[section][1][row].accountID){ 
            item.isChecked = "true";					
          }
          segData[section][1][row].flxChecked.accessibilityConfig = {
            a11yLabel: segData[section][1][row].lblAccountName,
      ...
      this.view.segCustomViews.setActive(row, section, "flxAccountsListCustomView.flxAccountsListWrapper.flxAccountListItem.flxChecked");
      if (kony.application.getCurrentBreakpoint() === 640 || orientationHandler.isMobile) {
        this.view.segCustomViews.setActive(row, section, "flxAccountsListCustomViewMobile.flxAccountsListWrapper.flxAccountListItem.flxChecked");
      }  
    },
    ...
    toggleCheckBox1: function() {
      ...
      if (segData[section][1][row].imgChecked1.text === OLBConstants.FONT_ICONS.CHECBOX_SELECTED) {
        this.accountsFlag++;
        segData[section][1][row].flxChecked1.accessibilityConfig = {
          a11yLabel: segData[section][1][row].lblAccountName1,
          "a11yARIA": {
            "tabindex": 0,
            "role": "checkbox",
            "aria-checked": true
        ...
        this.accountsFlag--;
        segData[section][1][row].flxChecked1.accessibilityConfig = {
          a11yLabel: segData[section][1][row].lblAccountName1.text,
          "a11yARIA": {
            "tabindex": 0,
            "role": "checkbox",
            "aria-checked": false
      ...
      accountsCheckBox1.forEach(function(item) {
        if (segData[section][1][row].imgChecked1.text === OLBConstants.FONT_ICONS.CHECBOX_SELECTED) {				
          if (item.accountID === segData[section][1][row].accountID1){ 
            item.isChecked = "true";					 
          }
          segData[section][1][row].flxChecked1.accessibilityConfig = {
            a11yLabel: segData[section][1][row].lblAccountName1,
      ...
      this.view.segCustomViews.setData(segData);	  
      this.view.segCustomViews.setActive(row, section, "flxAccountsListCustomView.flxAccountsListWrapper.flxAccountListItem1.flxChecked1");
      if (kony.application.getCurrentBreakpoint() === 640 || orientationHandler.isMobile) {
        this.view.segCustomViews.setActive(row, section, "flxAccountsListCustomViewMobile.flxAccountsListWrapper.flxAccountListItem.flxChecked");
      }
    },
    ...
    toggleHeaderCheckBox: function() {
      ...
      for (i = 0; i < segData[section][1].length; i++) {
        ...
        if (!kony.sdk.isNullOrUndefined(segData[section][1][i].imgChecked1)) {
          ...
          if (segData[section][1][i].imgChecked1.skin === "sknFontIconCheckBoxSelected") {
            segData[section][1][i].flxChecked1.accessibilityConfig = {
              a11yLabel: segData[section][1][i].lblAccountName1,
              "a11yARIA": {
                "tabindex": 0,
                "role": "checkbox",
                "aria-checked": true
          ...
          else if (segData[section][1][i].imgChecked1.skin === "sknC0C0C020pxolbfonticons") {
            segData[section][1][i].flxChecked1.accessibilityConfig = {
              a11yLabel: segData[section][1][i].lblAccountName1,
              "a11yARIA": {
                "tabindex": 0,
      ...
      if (segData[section][0].imgChecked.text === "D") {
        for (i = 0; i < segData[section][1].length; i++) {
          segData[section][1][i].flxChecked.accessibilityConfig = {
            a11yLabel: segData[section][1][i].lblAccountName,
            "a11yARIA": {
              "tabindex": 0,
              "role": "checkbox",
              "aria-checked": false
      ...
      else if (segData[section][0].imgChecked.text === "C") {
        for (i = 0; i < segData[section][1].length; i++) {
          segData[section][1][i].flxChecked.accessibilityConfig = {
            a11yLabel: segData[section][1][i].lblAccountName,
            "a11yARIA": {
      ...
      this.view.segCustomViews.setData(segData);	  
      if (kony.application.getCurrentBreakpoint() === 640 || orientationHandler.isMobile) {
        this.view.segCustomViews.setActive(-1, section, "flxAccountsHeaderCustomViewMobile.flxHeaderWrapper.flxSelectAll.flxChecked");
      }
      else {
        this.view.segCustomViews.setActive(-1, section, "flxAccountsHeaderCustomView.flxHeaderWrapper.flxSelectAll.flxChecked");
      }
    },
