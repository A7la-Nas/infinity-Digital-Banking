    ...
    return {
            ...
            if (uiData) {
                ...
                if (uiData.accountsSummary) {
                    ...
                    if (custDashboard === "true") {
                        var customerAccounts = accountsModule.presentationController.Customers;
                        this.customerAccounts = customerAccounts;
                        this.setCustomerData(customerAccounts);
                    }
                    ...
                    this.view.SegCustomers.setActive(this.segRowIndex, this.segSectionIndex, "flxCustomerListItem.flxFavourite");
                }
                    ...
                    "flxImg1": {
                        ...
                        "accessibilityConfig": {
                            "a11yARIA": {
                                "tabindex": 0,
                                "role": "button",
                                "aria-label": "Column Sorted in Ascending order. Click to Sort in Descending order"
                    ...
                    "flxImg2": {
                        ...
                        "accessibilityConfig": {
                            "a11yARIA": {
                                "tabindex": 0,
                                "role": "button",
                                "aria-label": "No Sort Applied. Click to Sort in Ascending order"
        ...
        */
        ...
        sortByNumber: function(context, colName, colNum, colCount) {
            var scopeObj = this;
            var sortType = "ASC";
            if (scopeObj.view.segCashFlow.data[0][0]["img" + colNum].src === "sorting_next.png") {
                ...
                scopeObj.view.segCashFlow.data[0][0]["flxImg" + colNum].accessibilityConfig = {
                    "a11yARIA": {
                        "role": "button",
                        "aria-label": "Column Sorted in Descending order. Click to Sort in Ascending order"
                    }
                }
            } else {
        ...
        resetUIforDashboardSwitching: function(self) {
            ...
            //for left container
            self.view.flxCustomerContainer.setVisibility(true); //Accounts Container
            self.view.AddExternalAccounts.setVisibility(false); //some intermediate step to add external accounts
            self.view.flxMyCashPosition.setVisibility(false); //MyCashPostion Container (Business Cash postion chart)
            self.view.upcomingTransactionsCombined.setVisibility(false); // Upcoming Transactions
            //for right container
            ...
            self.view.mySpending.setVisibility(false); //My Spending Charts
        ...
        preShow: function() {
            ...
            this.view.flxFilter.onKeyPress= this.onKeyPressCallBack;
            this.view.segCashFlow.isVisible = false;
            ...
            this.view.flxUpgradeDashboardDisclaimer.isVisible = false;
            this.view.flxUpgradeDisclaimerClose.onClick = function() {
                scp.view.flxUpgradeDashboardDisclaimer.isVisible = false;
            }
            var upgradePopup = this.presenter.presentationController.showUpgradePopup;
            if (!kony.sdk.isNullOrUndefined(upgradePopup) && upgradePopup == "upgrade") {
                this.view.flxUpgradeDashboardDisclaimer.isVisible = true;
            }
        ...
        onKeyPressCallBack: function(eventObject, eventPayload) {
            ...
            if(eventPayload.shiftKey && eventPayload.keyCode === 9 && self.view.SegDropDown.isVisible){
                self.view.SegDropDown.isVisible = false;
                self.view.lblCustDropDown.text = "O";
            }
        },
        onsegKeyPressCallBack: function(eventObject, eventPayload, context){
            var scope = this;
            if (eventPayload.keyCode === 27){
                scope.view.SegDropDown.isVisible = false;
                scope.view.lblCustDropDown.text = "O";
                eventPayload.preventDefault();
                scope.view.flxFilter.setActive(true);
            }
            ...
            if (eventPayload.keyCode === 9 && !eventPayload.shiftKey) {
                if (context.rowIndex === 1 && context.sectionIndex === 0) {
                    scope.view.SegDropDown.isVisible = false;
                    scope.view.lblCustDropDown.text = "O";
                }
            }
        ...
        preShowFrmAccountsLanding: function() {
            ...
            this.view.customheader.customhamburger.activateMenu("Overview", "");
        ...
        postShow: function() {
            ...
            this.view.flxApprovalAndRequest.doLayout = function(widget) {
                ...
                //this.view.flxDowntimeWarning.isVisible = false;
            this.view.flxFilter.accessbilityConfig = {
                        "a11yARIA": {
                            "aria-expanded": false,
                            "aria-labelledby": this.view.lblView.text+" "+this.view.lblFilterText.text,
                            "role": "button",
                            "tabindex": 0
                        },
                    }
            ...
            if (kony.application.getCurrentBreakpoint() === 640 || orientationHandler.isMobile) {
                this.view.flxCustomerContainerHeader.height = "100dp";
                this.view.flxCustomerSearch.width = "94%";
                this.view.flxCustomerSearch.left = "3%";
                this.view.flxFilter.left = "3%";
                this.view.flxFilter.width = "94%";
                this.view.flxCustomerSearch.top = "5dp";
                this.view.flxFilter.top = "50dp";
                this.view.lblDashboardHeading.setVisibility(false);
                this.view.PaginationContainer.bottom = "0px";
                this.view.flxMainWrapper.top = "20px";
                this.view.flxFooter.height = "100px";
            }
            ...
            this.view.lblView.text = "View:"
            this.view.lblFilterText.text = "All Customers";
            var scope = this;
            var segData = [];
            segData[0] = {
                "flxAccountTypes": {
                    "onKeyPress": scope.onsegKeyPressCallBack
                },
            ...
            this.view.flxFilter.accessibilityConfig = {
                    "a11yARIA": {
                        "aria-expanded": false,
                        "aria-label": this.view.lblView.text + this.view.lblFilterText.text,
                        "role": "button",
                        "tabindex": 0
                    }
                }
                //  this.view.SegCustomers.onRowClick = this.customerOnRowClick.bind(this);
        },
        ...
        searchBarConfig: function(accsLen) {
            ...
            var selectedfilter = this.view.lblFilterText.text;
            if (selectedfilter === "All Customers") {
                if (searchConfigCount > accsLen || searchConfigCount === 0) {
                    this.view.flxCustomerSearch.setVisibility(false);
                    return true;
                } else {
                    this.view.flxCustomerSearch.setVisibility(true);
                }
                return false;
            }
        },
        /**
          Method to enable or disable Favourite Icon based on spotlight configuration.
          */
        favouriteIconConfig: function(accsLen) {
            var searchConfigCount = applicationManager.getConfigurationManager().getConfigurationValue('favouriteCustomerCount');
            if (searchConfigCount > accsLen || searchConfigCount === 0) {
                return true;
            } else {
                return false;
        ...
        */
        ...
        initializeSearchAndFilterActions: function(accounts) {
            this.view.flxCustomerClearBtn.onClick = this.onSearchClearBtnClick.bind(this, accounts);
            this.view.txtCustomerSearch.onKeyUp = this.onTxtSearchKeyUp.bind(this, accounts);
            this.view.txtCustomerSearch.onDone = this.onSearchBtnClick.bind(this, accounts);
            this.view.btnConfirm.onClick = this.onSearchBtnClick.bind(this, accounts);
            //this.view.flxCustDropDown.onClick = this.onClickDropDown.bind(this);
            this.view.flxFilter.onClick = this.onClickDropDown.bind(this);
            this.view.SegDropDown.onRowClick = this.selectFilterOption.bind(this, accounts);
            //  this.view.CustomerListBox.onSelection = this.selectFilterOption.bind(this, accounts);          
        },
        onClickDropDown: function() {
            var favouriteIcon = this.favouriteIconConfig(this.customerAccounts.length);
            if (favouriteIcon === false) {
                this.view.lblCustDropDown.text === 'O' ? 'P' : 'O';
                if (this.view.lblCustDropDown.text === 'O') {
                    this.view.SegDropDown.isVisible = true;
                    this.view.lblCustDropDown.text = 'P';
                    this.view.flxFilter.accessibilityConfig = {
                        "a11yARIA": {
                            "aria-expanded": true,
                            "aria-label": this.view.lblView.text + this.view.lblFilterText.text,
                    ...
                    this.view.lblCustDropDown.text = 'O';
                    this.view.flxFilter.accessibilityConfig = {
                        "a11yARIA": {
                            "aria-expanded": false,
                            "aria-label": this.view.lblView.text + this.view.lblFilterText.text,
        ...
        selectFilterOption: function(accounts) {
            var scopeObj = this;
            var data = this.view.SegDropDown.data;
            var selectedRow = this.view.SegDropDown.selectedRowIndex[1];
            var selectedfilter = data[selectedRow].lblUsers;
            if (selectedfilter === "All Customers") {
                this.view.SegDropDown.isVisible = false;
                this.view.lblCustDropDown.text = 'O';
                this.view.lblFilterText.text = selectedfilter;
                this.setCustomerData(this.customerAccounts);
            } else {
                var recipientData = [];
                this.offset = 0;
                for (var index = 0; index < accounts.length; index++) {
                    if (accounts[index].favouriteStatus === "true") {
                        recipientData.push(accounts[index]);
                    }
                }
                this.view.SegDropDown.isVisible = false;
                this.view.lblCustDropDown.text = 'O';
                this.view.lblFilterText.text = selectedfilter;
                this.favoriteAccounts = recipientData;
                this.setCustomerData(recipientData);
            }
        ...
        setUserDashboardVisibility: function() {
            ...
            if (spendingPermissionCheck && applicationManager.getConfigurationManager().isMicroAppPresent(applicationManager.getConfigurationManager().microappConstants.FINANCEMANAGEMENT)) this.view.mySpending.setVisibility(false);
        ...
        onTxtSearchKeyUp: function(accounts) {
            var scopeObj = this;
            this.closePopupAndFilterScreens("all");
            var searchKeyword = scopeObj.view.txtCustomerSearch.text.trim();
            if (searchKeyword.length > 0) {
                scopeObj.view.flxCustomerClearBtn.setVisibility(true);
                this.view.flxSearch.forceLayout();
                hidePopups();
                var selectedfilter = this.view.lblFilterText.text;
                if (selectedfilter === "All Customers") {
                    var newdata = scopeObj.multipleCommonSegmentSearch(["MembershipName", "membershipId"], searchKeyword, this.customerAccounts)
                    scopeObj.setCustomerData(newdata);
                } else {
                    var favData = scopeObj.multipleCommonSegmentSearch(["MembershipName", "membershipId"], searchKeyword, this.favoriteAccounts)
                    scopeObj.setCustomerData(favData);
                }
                scopeObj.view.forceLayout();
                scopeObj.AdjustScreen();
            } else {
                scopeObj.view.flxCustomerClearBtn.setVisibility(false);
                ...
                if (selectedfilter === "All Customers") {
                    ...
                    scopeObj.setCustomerData(this.favoriteAccounts);
                }
                scopeObj.view.forceLayout();
                scopeObj.AdjustScreen();
            }
        ...
        onSearchClearBtnClick: function(accounts) {
            var scopeObj = this;
            scopeObj.view.txtCustomerSearch.text = "";
            scopeObj.view.flxCustomerClearBtn.setVisibility(false);
            var data = this.customerAccounts;
            //  scopeObj.view.SegCustomers.setData(data);
            var selectedfilter = this.view.lblFilterText.text;
        ...
        getSearchAndFilterData: function(accounts) {
            var scopeObj = this;
            var searchQuery = scopeObj.view.txtCustomerSearch.text.trim();
            var data = accounts;
            if (!kony.sdk.isNullOrUndefined(searchQuery) && searchQuery !== "") {
                for (var i = 0; i < data.length; i++) {
                    var rowdata = data.filter(function(record) {
                        return ((record["membershipId"] && record["membershipId"].toUpperCase().indexOf(searchQuery.toUpperCase()) !== -1) || (record["MembershipName"] && record["MembershipName"].toUpperCase().indexOf(searchQuery.toUpperCase()) !== -1));
                    });
                    if (rowdata.length === 0) {
                        data.splice(i, 1);
                        i--;
        ...
        /**
         * method to get data from search values
         */
        multipleCommonSegmentSearch: function(field, searchText, data) {
            var searchdata = [];
            for (var i = 0; i < data.length; i++) {
                for (var j = 0; j < field.length; j++) {
                    if (!kony.sdk.isNullOrUndefined(data[i][field[j]]) && data[i][field[j]].toLowerCase().indexOf(searchText) >= 0 || data[i][field[j]].toUpperCase().indexOf(searchText) !== -1) {
        ...
        updateAccountWidget: function(accounts, isDashboardSwitcher) {
            ...
            if (kony.application.getCurrentBreakpoint() === 640 || orientationHandler.isMobile) {
                ...
                CommonUtilities.setText(this.view.customheader.lblHeaderMobile, kony.i18n.getLocalizedString('i18n.common.overview'), accessibilityConfig);
            } else {
                this.view.customheader.customhamburger.activateMenu("Overview", "");
            }
...
*/
        ...
        isFavourite: function(account) {
            return account.favouriteStatus && account.favouriteStatus === 'true';
        },
        /**
        ...
        layoutWarningFlexes: function() {
            ...
            this.view.flxPasswordResetWarning.top = "30dp";
            ...
            var approvalData = [
                [{
                        ...
                        btnShowAll: {
                            ...
                            "accessibilityConfig": {
                                "a11yLabel": kony.i18n.getLocalizedString("i18n.common.viewAll") + " " + kony.i18n.getLocalizedString("i18n.konybb.MyApprovals.Header") + "\(" + totalCount + "\)",
                            },
                            onClick: function() {
                                var navigationObject = {
                                    "requestData": null,
            ...
            var requestData = [
                [{
                        ...
                        btnShowAll: {
                            "text": kony.i18n.getLocalizedString("i18n.common.viewAll"),
                            "accessibilityConfig": {
                                "a11yLabel": kony.i18n.getLocalizedString("i18n.common.viewAll") + " " + kony.i18n.getLocalizedString("i18n.konybb.ACH.Requests") + "\(" + totalCount + "\)"
                            },
                            onClick: function() {
                                var navigationObject = {
                                    "requestData": null,
        ...
        widgetPositioningOnBreakpointChange: function(width) {
            ...
            if (width === 1024 || orientationHandler.isTablet || width === 640 || orientationHandler.isMobile) {
                ...
                if (!this.view.flxLeftContainer.widgets().includes(spendingsWidget)) {
                    ...
                    if (!kony.sdk.isNullOrUndefined(document.getElementById('frmCustomerDashboard_mySpending_donutChart1'))) {
                        var container = document.getElementById('frmCustomerDashboard_mySpending_donutChart1');
        ...
        setCustomerData: function(customerAccount, config) {
            var scope = this;
            this.view.PaginationContainer.setLowerLimit(1);
            this.view.PaginationContainer.setPageSize(3);
            this.view.SegCustomers.rowTemplate = "flxCustomerListItem";
            var dataMap = {
                "lblAccountName": "lblAccountName",
            ...
            this.view.SegCustomers.widgetDataMap = dataMap;
            var favouriteIcon = this.favouriteIconConfig(this.customerAccounts.length);
            if (customerAccount !== undefined) {
                if (kony.application.getCurrentBreakpoint() === 640 || orientationHandler.isMobile) {
                    var data = customerAccount.map(function(res) {
                        return {
                            ...
                            "flxAvailableBalanceWrapper": {
                                "right": "5%"
                            },
                            "flxAvailableBalances": {
                                "width": "100%"
                            },
                            "imgStarIcon": {
                                "text": res.favouriteStatus === "true" ? "F" : "k"
                            },
                            "flxFavourite": {
                                "isVisible": favouriteIcon === true ? false : true,
                            ...
                            "flxContent": {
                                "onClick": function(eventobject, segInfo, xcoord, context) {
                                    scope.customerOnRowClick(segInfo);
                                }.bind(this)
                            }
                        }
                    });
                ...
                this.view.SegCustomers.setData(data.slice(this.offset, this.lastRecord));
                // this.view.SegCustomers.onRowClick = this.customerOnRowClick.bind(this);
                this.view.forceLayout();
                this.initializeSearchAndFilterActions(customerAccount);
                var searchBarConfigResp = this.searchBarConfig(this.customerAccounts.length);
                var filterConfigResp = this.filterConfig(this.customerAccounts.length);
                if (searchBarConfigResp && filterConfigResp) {
                    this.view.flxCustomerContainerHeader.setVisibility(false);
                } else {
                    this.view.flxCustomerContainerHeader.setVisibility(true);
                }
                this.view.lblCustomers.text = "Customers (" + data.length + ")";
                this.view.forceLayout();
            }
        },
        setCustfavStatus: function(context) {
            ...
            var coreCustomerId = context.widgetInfo.data[index].lblAccountNumberValue.text.substring(12);
            if (context.widgetInfo.data[index].imgStarIcon.text === "F") {
        ...
        customerOnRowClick: function(context) {
            var index = context.rowIndex;
            var coreCustomerId = context.widgetInfo.data[index].lblAccountNumberValue.text.substring(12);
            var coreCustomerName = context.widgetInfo.data[index].lblAccountName.text;
            // var coreCustomerId = eventobject.selectedRowItems[0].lblAccountNumberValue.text.substring(12);
            var params = {
                Membership_id: coreCustomerId
            };
            var accountsModule = kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule("AccountsUIModule");
            accountsModule.presentationController.customerId = params.Membership_id;
            accountsModule.presentationController.customerIdName = coreCustomerName;
            accountsModule.presentationController.getcustomerAccounts(params);
        },
        setPagination: function(values, viewModel) {
            var paginationCount = applicationManager.getConfigurationManager().getConfigurationValue('customersPerPage');
            if (paginationCount > this.customerAccounts.length || paginationCount === 0) {
            ...
            this.view.PaginationContainer.lblPagination.text = (values.offset + 1) + " - " + lastRecord + " Customers";
			...
			this.view.PaginationContainer.flxPagination.right = "-7dp";
			this.view.PaginationContainer.top = "10dp";
        ...
        onFirst: function(values, viewModel) {
            ...
            this.setCustomerData(viewModel, values);
        },
        ...
        showLargeAccLoadPopup: function() {
            if (kony.application.getCurrentForm().id === "frmCustomerDashboard") {
                kony.application.getCurrentForm().customheader.flxHamburger.isVisible = false;
                kony.application.getCurrentForm().customheader.flxHamburgerBack.isVisible = false;
            }
            var scope = this;
            if (kony.application.getCurrentBreakpoint() === 640 || orientationHandler.isMobile) {
                this.view.lblLargeAcconts.height = "60dp";
                this.view.flxLoadPopup.width = "400dp";
            }
            this.view.flxLargeAccLoadPopup.isVisible = true;
            this.view.btnOK.onClick = function() {
                scope.view.flxLargeAccLoadPopup.isVisible = false;
            }
        },
        onNavigate:function(){
            var scope = this;
